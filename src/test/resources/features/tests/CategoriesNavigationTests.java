...
//
//import com.demoblaze.common.helpers.files.pages.SearchCategoryPage;
...
//    @BeforeMethod
//    public void setup(){
//        searchCategoryObject = new SearchCategoryPage(TestBase.driver);
//    }
//
...
//        List<WebElement> categoryElements = TestBase.driver.findElements(By.id("itemc"));
...
//        List<WebElement> products = TestBase.driver.findElements(By.className("col-lg-4.col-md-6.mb-4"));
//        int phonesIndex = 1;
